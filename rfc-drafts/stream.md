...
At the moment, we do not see any `Unpin!` streams in practice. Where they will become important is when we introduce async generators, as discussed in [future-possibilities].
